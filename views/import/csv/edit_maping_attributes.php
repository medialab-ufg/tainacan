    ...
    <div id="importForm_csv" class='panel-body'>
        <form id="form_import_csv_delimit"> 
            <div class="form-group">
                ...
                <input type="text" id="socialdb_delimiter_csv" name="socialdb_delimiter_csv">
            </div>
            <h5><strong><?php _e('CSV Header','tainacan'); ?></strong></h5>
            <div class="form-group">
                <label class="radio-inline">
                    <input type="radio" name="socialdb_csv_has_header" id="socialdb_csv_has_header_yes" value="1"> <?php _e('Yes','tainacan'); ?>
                </label>
                <label class="radio-inline">
