...
<div class='panel panel-default'>
    <div id="importForm" class='panel-body'>
        <form id="form_import"> 
        <center><h3><?php _e('Objects Found: ') ?> <?php echo $number_of_objects; ?></h3></center>
        ...
        <div class="form-group">
            <!--label for="library_type"><?php _e('Import OAI-PMH'); ?></label><br-->
            <input type="radio" name="import_object" onclick="show_message_size()"  value="true"><?php _e('Import object'); ?><br>
            <input type="radio" name="import_object" checked="checked"  value="false"><?php _e('Import only metadata'); ?><br>
        </div>
    ...
    <button id="cancel_button_import" class="btn btn-default" onclick="cancel_import()"><?php echo __('Cancel'); ?></button>
    <button id="submit_button_import" class="btn btn-primary" onclick="save_mapping('<?php echo $url; ?>')"><?php echo __('Save'); ?></button>
