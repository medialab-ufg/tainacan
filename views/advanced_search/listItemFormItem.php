        ...
        while ($loop_objects->have_posts()) : $loop_objects->the_post();
            ...
            <tr id="line_property_object_<?php echo $compound_id ?>_<?php echo $property_id ?>_<?php echo $contador ?>_<?php echo get_the_ID() ?>">
                <td style="width: 100%;font-size: 12pt;"
                    class="title-text" 
                    onclick="temporary_insert_items_compound_<?php echo $compound_id ?>_<?php echo $property_id; ?>_<?php echo $contador_id; ?>('<?php echo get_the_ID() ?>','<?php echo $contador ?>')">
...
<div class="col-md-12 no-padding" style="padding-right: 0px;margin-top: 15px;">
    ...
    <button type="button" 
            ...
            onclick="save_selected_items_property_object_compound_<?php echo $compound_id ?>_<?php echo $property_id; ?>_<?php echo $contador_id; ?>()">
        <?php _e('Add','tainacan')?>
    </button>
</div>
<script>
    $(function(){
        ...
        $.each($('#results_property_<?php echo $compound_id ?>_<?php echo $property_id; ?>_<?php echo $contador_id; ?> ul li'),function(index,value){
    ...
    function temporary_insert_items_compound_<?php echo $compound_id ?>_<?php echo $property_id; ?>_<?php echo $contador_id; ?>(id,contador){
        if(!$('#line_property_object_<?php echo $compound_id ?>_<?php echo $property_id ?>_'+contador+'_'+id+' .item_values_'+id).is(':checked')){
            ...
            remove_line_property_object_compound_<?php echo $compound_id ?>_<?php echo $property_id; ?>_<?php echo $contador_id; ?>(id);
        }
    }
    //remove o item dos temporarios
    function remove_line_property_object_compound_<?php echo $compound_id ?>_<?php echo $property_id; ?>_<?php echo $contador_id; ?>(id){
    ...
    function save_selected_items_property_object_compound_<?php echo $compound_id ?>_<?php echo $property_id; ?>_<?php echo $contador_id; ?>(){
        var results = 0;
            ...
            if($('#inserted_property_object_<?php echo $compound_id ?>_<?php echo $property_id ?>_<?php echo $contador ?>_'+$(value).val()).length==0){
               ...
               // $('#line_property_object_<?php echo $property_id ?>_'+$(value).val()+' .item_values_'+$(value).val()).attr('disabled','disabled');
                ...
                $('#results_property_<?php echo $compound_id ?>_<?php echo $property_id ?>_<?php echo $contador ?> ul')
                        ...
                        +'<span  onclick="remove_item_objet_<?php echo $compound_id ?>_<?php echo $property_id; ?>_<?php echo $contador_id; ?>(this)" style="cursor:pointer;" class="pull-right glyphicon glyphicon-trash"></span></li>');
                add_in_item_value_compound_<?php echo $compound_id ?>_<?php echo $property_id; ?>_<?php echo $contador_id; ?>($(value).val());
            }
        });
        if(results>0){
    ...
    function remove_item_objet_<?php echo $compound_id ?>_<?php echo $property_id; ?>_<?php echo $contador_id; ?>(seletor){
        var id = $(seletor).parent().attr('item');
        remove_line_property_object_compound_<?php echo $compound_id ?>_<?php echo $property_id; ?>_<?php echo $contador_id; ?>(id);//retirando do contianer abaixo
        $(seletor).parent().remove();
        remove_in_item_value_compound_<?php echo $compound_id ?>_<?php echo $property_id; ?>_<?php echo $contador_id; ?>(id);//retirando do item
    ...
    function add_in_item_value_compound_<?php echo $compound_id ?>_<?php echo $property_id; ?>_<?php echo $contador_id; ?>(id){
    ...
    function remove_in_item_value_compound_<?php echo $compound_id ?>_<?php echo $property_id; ?>_<?php echo $contador_id; ?>(id){
