...
class social_media extends WP_Widget {
    ...
    public function widget( $args, $instance ){
        ...
        echo '<a class="smedialink" href="'. $facebook_url .'"><img class="backicon" src="'. get_template_directory_uri() .'/libraries/images/icon_smedia_widget/004-facebook-logo-button.png" alt="Facebook" />    Facebook</br></a>';
        echo '<a class="smedialink" href="'. $youtube_url .'"><img class="backicon" src="'. get_template_directory_uri() .'/libraries/images/icon_smedia_widget/005-play.png" alt="Youtube" />    Youtube</br></a>';
        echo '<a class="smedialink" href="'. $twitter_url .'"><img class="backicon" src="'. get_template_directory_uri() .'/libraries/images/icon_smedia_widget/003-twitter-logo-button.png" alt="Twitter" />    Twitter</br></a>';
        echo '<a class="smedialink" href="'. $googleplus_url .'"><img class="backicon" src="'. get_template_directory_uri() .'/libraries/images/icon_smedia_widget/002-google-plus-logo-button.png" alt="Google Plus" />    Google Plus</br></a>';
        echo '<a class="smedialink" href="'. $github_url .'"><img class="backicon" src="'. get_template_directory_uri() .'/libraries/images/icon_smedia_widget/001-github-logo.png" alt="Github"/>    Github</a>';
