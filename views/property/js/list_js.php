...
//        else {
      ...
      //  }
        ...
        <?php if(!$is_root): ?>
        autocomplete_metadata(<?php echo $category->term_id; ?>,'data','autocomplete_property_data');
        autocomplete_metadata(<?php echo $category->term_id; ?>,'object','autocomplete_property_object');
        autocomplete_metadata(<?php echo $category->term_id; ?>,'term','autocomplete_property_term');
     <?php endif; ?>
  ...
  <?php // Submissao do form de property data     ?>
        $('#submit_form_property_data').submit(function (e) {
            ...
            $.ajax({
                ...
                list_property_data();
                clear_buttons();
                 //se estiver na pagina de categoria
