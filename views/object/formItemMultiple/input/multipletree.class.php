...
class MultipleTreeClass extends FormItemMultiple {
    var $hasDefaultValue;
            ...
            Hook.register(
                    ...
                    function ( args ) {
                        $.ajax({
                            ...
                            if(json.value){
                                $("#multiple-<?php echo $compound_id ?>-<?php echo $property_id ?>-<?php echo $index_id; ?>").dynatree("getRoot").visit(function (node) {
