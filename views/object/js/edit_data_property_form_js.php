<script>
    $(function () {
        var src = $('#src').val();
        $('#submit_form_edit_property_data').submit(function (e) {
            $.ajax({
                ...
                list_properties_edit_remove($('#event_edit_property_data_object_id').val());
                elem = jQuery.parseJSON(result);
                back_button($('#event_edit_property_data_object_id').val());// o id do objeto
                list_properties($('#event_edit_property_data_object_id').val());// o id do objeto
