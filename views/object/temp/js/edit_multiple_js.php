<script>
    ...
    $(function () {
        ...
        // $("#tainacan-breadcrumbs .current-config").text('<?php _e('Add new item - Edit file(s) metadata','tainacan') ?>');
        ...
        // 5# - autocomplete dos metadados de dados
