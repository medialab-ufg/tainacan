                ...
                <form name="form_share_item<?php echo get_the_ID() ?>" id="form_share_item<?php echo get_the_ID() ?>" method="post">
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            <a target="_blank" href="https://plus.google.com/share?url=<?php echo the_permalink(get_the_ID()); ?>">
                                <?php echo ViewHelper::render_icon('googleplus-square', 'png', 'Google Plus'); ?></a>
                            <br><br>
            ...
            <form method="post" id="formDuplicateItem<?php echo $curr_id ?>">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <label for="duplicate_item" class="version"> <?php _e('Versioning', 'tainacan'); ?> </label> <br>
