...
<hr>
<h4 id="create-text-term" ><?php echo __('Create object metadata','tainacan') ?></h4>
<form  id="single_submit_form_property_object">
    ...
    <div class="create_form-group">
        <label for="event_add_property_object_name"><?php _e('Name','tainacan'); ?></label>
    ...
    <div class="form-group">
        <label for="event_add_property_object_required"><?php _e('Required','tainacan'); ?>:&nbsp;</label>
