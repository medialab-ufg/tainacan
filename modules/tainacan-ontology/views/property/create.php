...
<div id="categories_title" class="row">
    ...
    <div class="col-md-10">
            <h3>
                <?php echo (isset($property_parent->term_id))? __('Add sub-property in','tainacan').' '.$property_parent->name: __('Create Property','tainacan') ?> <?php echo $property->name; ?>
            ...
            <div class="tab-content">
                <div role="tabpanel" class="tab-pane active" id="property_data_tab">
                    <form   id="submit_form_property_data">
                        <input type="hidden" name="property_category_id"  value="0">
