<!-- Positive argument -->
    <div class="modal fade" 
         ...
         tabindex="-1" 
         role="dialog" 
         aria-labelledby="modalAddAnswer" 
         aria-hidden="true">
                ...
                <form id="form_answer">
                    <div class="modal-header">
                        ...
                        <h4 class="modal-title" 
                            id="myModalLabel">
                                <?php _e('New Answer','tainacan') ?>
                        </h4>
                    </div>
                    <div class="modal-body"  >
                        <div class="form-group">
                            <i><b>"<span id="answer_text"></span>"</b></i>
                        </div>
                        <hr>
                        <div  class="form-group">
                           <label for="exampleInputPassword1">
                               &nbsp;<?php _e('Insert a new answer','tainacan') ?></label>
                            <textarea required="required" name="answer_argument" class="form-control"   ></textarea>
                        </div>
                        <div  class="form-group" style="margin-bottom: -10px;">
                            <center>
                                <a style="cursor: pointer;" onclick="toggle_additional_information('#properties_answer')">
                                    <?php _e('Additional informations','tainacan') ?><br>
                                    <span class="glyphicon glyphicon-chevron-down"></span>
                                </a>    
                            </center>
                            <div style="display: none;" id="properties_answer"></div>
                        </div>    
                        <input type="hidden" id="collection_answer_id" name="collection_id" value="">
