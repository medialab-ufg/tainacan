	 ...
	 public function operation($operation,$data){
         ...
         switch ($operation) {
             ...
             case 'get_url_category':
                 ...
                 $_usr_id = get_current_user_id();
                 if($category){
                     $log_data = [
                         'collection_id' => $data['collection_id'], 'resource_id' => $category->term_id,
                         'user_id' => $_usr_id, 'event_type' => 'user_category', 'event' => 'view'
                     ];
                     Log::addLog($log_data);
                     ...
                     $log_data = [
                         'collection_id' => $data['collection_id'], 'resource_id' => $tag->term_id,
                         'user_id' => $_usr_id, 'event_type' => 'tags', 'event' => 'view'
                     ];
                     Log::addLog($log_data);
