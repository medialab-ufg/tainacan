...
function create_event_terms() {
    ...
    $event_edit_property_compounds = create_register('socialdb_event_property_compounds_edit', 'socialdb_event_type', array('parent' => $event_property_compounds_compounds['term_id']));
...
function get_item_thumb_image($item_id, $size="thumbnail") {
    if (get_the_post_thumbnail($item_id, $size)) {
        ...
        return '<img src="' . get_item_thumbnail_default($item_id) . '" class="img-responsive" style="max-width: 100% !important">';
    }
}
