...
//			l.style("top", y).style("left", x).style("display", "block");
			...
			l.style("display", "none");
                    ...
                    if(d.uri.indexOf('?category=')>0||d.uri.indexOf('?property=')>0||d.uri.indexOf('?item=')>0){
                        //alert(d.uri);
                       // parent.showGraph(d.uri);
                      // restart(d.uri+'.rdf');
                    }else if(d.uri.indexOf('/collection/')>0){
                      // restart(d.uri+'?all.rdf'); 
                    }
		});
...
//      .text(xy.scale());    
//  vis.attr("transform", "translate(" +  xy.translate() + ") "
//		+"scale(" + xy.scale() + ")");
//}
//
//
