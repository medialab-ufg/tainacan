                                    ...
                                    <?php if (current_user_can('manage_options')): ?>
                                        ...
                                        <li class="admin-config-menu">
                                            ...
                                            <ul class="admin-config-submenu" aria-expanded="false">
                                                ...
                                                <li><a onclick="showImportFull('<?php echo get_template_directory_uri() ?>');" onmouseover="" href="#"><span  class="glyphicon glyphicon-asterisk"></span> <?php _e('Import', 'tainacan'); ?></a></li>
                                                <li><a onclick="showExportFull('<?php echo get_template_directory_uri() ?>');" onmouseover="" href="#"><span  class="glyphicon glyphicon-asterisk"></span> <?php _e('Export', 'tainacan'); ?></a></li>
                                            </ul>
                                        </li>
                                    <?php endif; ?>
                                </ul>
