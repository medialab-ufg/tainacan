...
include_once ( dirname(__FILE__) . '/../../views/theme_options/js/edit_tools_js.php');
?>
<div class="col-md-12">
    <div class="col-md-12 config_default_style">
        <?php ViewHelper::render_config_title( _t("Tools") ); ?>
        ...
        <div class="tab-content">
            ...
            <div id="aba-teste-integridade" class="tab-pane fade">
                ...
                <form  id="submit_form_integrity_test">
                    ...
                    <button type="submit" id="submit_integrity"  class="btn btn-primary pull-left"><?php _e('Start Test', 'tainacan'); ?></button>
                </form>
                <br>
            ...
            <div id="aba-reindexacao" class="tab-pane fade">
                ...
                <form id="reindexation_form">
                    ...
                    <input type="hidden" name="operation" value="reindex">
                    <br>
