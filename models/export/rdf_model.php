...
################################# begin:item ###################################    
    ...
    public function generate_complete_rdf_simple_item($content){
        ...
        xmlns:collection="'.  get_the_permalink().'"
    ...
    public function get_rdf_item_simple($item) {
        ...
        $xml = '<'.$collection_term_root->slug.' rdf:about="'.  get_permalink($this->collection->ID).'?item='.$this->item_name.'"  >';
